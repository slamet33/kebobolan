...
class PlayerDetailRepository() {
    fun getDataPlayers(namePlayer: String?, callback: RepositoryCallback<ResponsePlayers>) {
        ConfigRetrofit.service.getPlayerDetail(namePlayer.toString()).enqueue(object : Callback<ResponsePlayers> {
