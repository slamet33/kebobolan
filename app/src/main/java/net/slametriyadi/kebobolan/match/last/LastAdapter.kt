...
class LastAdapter(private val teams: List<MatchItem>, var context: Context?) : RecyclerView.Adapter<TeamViewHolder>() {
...
class TeamViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bind(dataMatch: MatchItem, context: Context?) {
        ...
        dateMatch?.text = parseDate(dataMatch.dateEvent.toString(), DateHelper.inputDateFormat(), DateHelper.outputDateFormat())
